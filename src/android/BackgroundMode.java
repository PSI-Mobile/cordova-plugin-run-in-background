...
public class BackgroundMode extends CordovaPlugin {
    ...
    private enum Event { ACTIVATE, DEACTIVATE, FAILURE, GETHELP }
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        cordova.getActivity().registerReceiver (receiverScreenState, screenStateFilter);
    ...
    private BroadcastReceiver receiverScreenState = new BroadcastReceiver() {

        private long lastButtonPressed = 0;
        private long countButtonPressed = 0;

        @Override
        public void onReceive(Context context, Intent intent) {
            if (this.lastButtonPressed == 0 || System.currentTimeMillis () - this.lastButtonPressed > 2500) {
            ...
            if (this.countButtonPressed >= 5) {
                fireEvent(Event.GETHELP, "'GET HELP'");
